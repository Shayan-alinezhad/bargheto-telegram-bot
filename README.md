# ⚡ برق تو — ربات قطعی برق مازندران

یک ربات تلگرامی مبتنی بر **Cloudflare Workers** و **JavaScript** برای دریافت، جست‌وجو و نمایش برنامه خاموشی‌های استان مازندران.

این پروژه اطلاعات را از وب‌سایت `baboliha.ir` دریافت می‌کند، شهر موردعلاقه کاربران را در **Cloudflare D1** نگه می‌دارد و یک پنل مدیریت واکنش‌گرا برای مشاهده کاربران و شهرهای ذخیره‌شده ارائه می‌دهد.
